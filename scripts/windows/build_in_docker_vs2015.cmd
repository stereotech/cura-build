...
echo CLIPARSER_BRANCH_OR_TAG = "%CLIPARSER_BRANCH_OR_TAG%"
...
cmake -DCMAKE_BUILD_TYPE=Release ^
      ...
      -DCLIPARSER_DEPLOY_USERNAME="%CLIPARSER_DEPLOY_USERNAME%" ^
      -DCLIPARSER_DEPLOY_TOKEN="%CLIPARSER_DEPLOY_TOKEN%" ^
      -DCLIPARSER_BRANCH_OR_TAG="%CLIPARSER_BRANCH_OR_TAG%" ^
