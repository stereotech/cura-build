...
echo 
echo STESLICERPLUGINS_DEPLOY_USERNAME  = "%STESLICERPLUGINS_DEPLOY_USERNAME%"
echo STESLICERPLUGINS_DEPLOY_TOKEN  = "%STESLICERPLUGINS_DEPLOY_TOKEN%"
echo
...
echo STESLICERBINARYDATA_BRANCH_OR_TAG = "%STESLICERBINARYDATA_BRANCH_OR_TAG%"
echo STESLICERPLUGINS_BRANCH_OR_TAG = "%STESLICERPLUGINS_BRANCH_OR_TAG%"
...
cmake -DCMAKE_BUILD_TYPE=Release ^
      ...
      -DSTESLICERBINARYDATA_BRANCH_OR_TAG="%STESLICERBINARYDATA_BRANCH_OR_TAG%" ^
      ...
      -DSTESLICERPLUGINS_DEPLOY_USERNAME="%STESLICERPLUGINS_DEPLOY_USERNAME%" ^
      -DSTESLICERPLUGINS_DEPLOY_TOKEN="%STESLICERPLUGINS_DEPLOY_TOKEN%" ^
      -DSTESLICERPLUGINS_BRANCH_OR_TAG="%STESLICERPLUGINS_BRANCH_OR_TAG%" ^
